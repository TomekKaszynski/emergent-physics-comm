...
=====================================
Same as _phase54e_pop_simultaneous.py (population + simultaneous reset + vocab=5)
but with 20 seeds (0-19) to characterize the bimodal distribution.

Run:
  PYTHONUNBUFFERED=1 PYTORCH_ENABLE_MPS_FALLBACK=1 python3 _phase54e_20seeds.py
"""
...
def main():
    print("=" * 70, flush=True)
    print("Phase 54e: 20-seed characterization", flush=True)
    print("=" * 70, flush=True)
    ...
    # ════════════════════════════════════════════════════════════
    print(f"\n\n{'='*70}", flush=True)
    print(f"FULL TABLE: Phase 54e 20-seed characterization", flush=True)
    ...
    save_path = RESULTS_DIR / "phase54e_20seeds.json"
