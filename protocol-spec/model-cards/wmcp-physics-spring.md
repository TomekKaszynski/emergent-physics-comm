...
Protocol trained on MIT Physics 101 spring scenario. Objects are released between two springs; agents communicate about mass properties inferred from oscillation dynamics.
...
- **Training data:** MIT Physics 101 — spring scenario (206 clips, 26 objects)
...
|-----------|----------|--------|
| Heterogeneous (V-JEPA+DINOv2) | 81.8% | 0.764 |
| Homogeneous V-JEPA | 82.5% | — |
| Homogeneous DINOv2 | 74.5% | — |

## Intended Use

Robotics manipulation where grip force must be estimated from visual observation of object response to applied forces.
...
# Load weights
protocol.load_state_dict(torch.load("wmcp-physics-spring.pt"))
...
- Validated on spring physics only; does not transfer to other scenarios
