def run_phase48d_centroid_dynamics():
    ...
    }, str(OUTPUT_DIR / "phase48d_model.pt"))
    ...
    plt.tight_layout()
    plt.savefig(str(OUTPUT_DIR / "phase48d_centroid_dynamics.png"),
                dpi=150, bbox_inches='tight')
    plt.close()
    print(f"│  Saved results/phase48d_centroid_dynamics.png", flush=True)
